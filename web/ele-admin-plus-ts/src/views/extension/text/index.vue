  ...
  <ele-page>
    ...
    <ele-card header="文本组件">
      <div style="line-height: 1.8" class="demo-text-group">
        ...
        <ele-text :icon="UserOutlined" type="secondary">&nbsp;二级文本</ele-text>
        <ele-text :icon="UserOutlined" type="placeholder">&nbsp;提示文本</ele-text>
    ...
    <ele-card header="文本复制">
      ...
      <div style="display: flex; align-items: center; max-width: 280px">
        <el-input v-model="text" placeholder="请输入" style="flex: 1; margin-right: 8px" />
    ...
    <ele-card header="状态文本">
      <option-item label="默认效果">
        <el-space size="large">
          ...
          <ele-dot type="success" :ripple="ripple" text="已上线" :size="dotSize" />
    ...
    <ele-card header="状态仪表盘">
      ...
      <div style="margin: 32px 0 14px 0; max-height: 100%"> 自定义颜色和尺寸: </div>
      <div>
