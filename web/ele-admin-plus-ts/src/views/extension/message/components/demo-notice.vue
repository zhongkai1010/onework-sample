<template>
  <ele-card header="消息通知">
    <option-item label="使用">
      <el-button @click="showNotification()" class="ele-btn-icon"> 打开通知 </el-button>
      <el-button @click="showNotification('success')" class="ele-btn-icon"> 带图标 </el-button>
      <el-button @click="showNotification('info', 0)" class="ele-btn-icon"> 不自动关闭 </el-button>
    </option-item>
...
<script lang="ts" setup>
  ...
  import type { NotificationProps } from 'element-plus/es'
