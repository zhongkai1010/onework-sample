  ...
  <el-row :gutter="16">
    <el-col :md="6" :sm="12" :xs="24">
      <ele-card class="monitor-count">
        ...
        <ele-text type="placeholder" class="monitor-count-text"> 总访问人数 </ele-text>
...
<script lang="ts" setup>
  ...
  const visitUsers = ref<AvatarItem[]>([
    ...
    },
    {
      key: 2,
      label: '你的名字很好听',
      value: 'https://cdn.eleadmin.com/20200609/b6a811873e704db49db994053a5019b2.jpg'
    },
    {
      key: 3,
      label: '全村人的希望',
    ...
    },
    {
      key: 4,
      label: 'Jasmine',
      value: 'https://cdn.eleadmin.com/20200609/f6bc05af944a4f738b54128717952107.jpg'
    },
    {
      key: 5,
      label: '酷酷的大叔',
