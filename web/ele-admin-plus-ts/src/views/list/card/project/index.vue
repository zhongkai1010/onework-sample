  ...
  <ele-page :multi-card="false">
    ...
    <el-row :gutter="16">
      <el-col v-for="item in data" :key="item.id" :lg="6" :md="8" :sm="12" :xs="24">
        <ele-card shadow="hover" :body-style="{ padding: 0 }" style="margin-top: 16px; overflow: hidden; cursor: pointer">
          <img :src="item.cover" style="width: 100%" />
          <div style="padding: 14px 24px 24px 24px">
            <ele-text size="md" style="max-height: 100%">
              {{ item.title }}
            </ele-text>
            <ele-ellipsis :max-line="2" type="placeholder" style="margin: 8px 0 16px 0; max-height: 100%">
              {{ item.content }}
            </ele-ellipsis>
            <div style="display: flex; align-items: center">
              ...
              <ele-avatar-group size="small" :data="item.users" style="flex-shrink: 0" />
            </div>
          </div>
        </ele-card>
      </el-col>
    ...
    data.value = [
      {
        ...
        users: [
          {
            label: 'SunSmile',
            value: 'https://cdn.eleadmin.com/20200609/c184eef391ae48dba87e3057e70238fb.jpg'
          },
          {
            label: '酷酷的大叔',
            value: 'https://cdn.eleadmin.com/20200609/2d98970a51b34b6b859339c96b240dcd.jpg'
          },
          {
            label: 'Jasmine',
            value: 'https://cdn.eleadmin.com/20200609/948344a2a77c47a7a7b332fe12ff749a.jpg'
          }
        ]
      },
      {
