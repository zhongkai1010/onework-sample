<template>
  ...
  <el-drawer v-model="open" title="页面内容" direction="rtl" size="50%" :destroy-on-close="true">
    <el-descriptions title="页面内容" :column="1" size="large" :border="true" :label-width="200">
      ...
      <el-descriptions-item label="搜索条件">作品名称</el-descriptions-item>
      <el-descriptions-item label="操作栏">新增 导出</el-descriptions-item>
      <el-descriptions-item label="表格字段" :span="24">编号 作品名称 创作年代 尺寸 材质 题材 装裱 艺术家名称 操作时间 作品图片 操作</el-descriptions-item>
