    ...
    <el-row :gutter="8">
      <el-col :xl="4" :lg="6" :md="8" :sm="12" :xs="24">
        <el-form-item label="地址信息" label-width="auto">
          <el-input v-model="form.name" placeholder="请输入地址信息" clearable @keyup.enter="handleSearch" />
        </el-form-item>
      </el-col>
      <el-col :xl="4" :lg="6" :md="8" :sm="12" :xs="24">
        <el-form-item label="地址码" label-width="auto">
          <el-input v-model="form.code" placeholder="请输入地址码" clearable @keyup.enter="handleSearch" />
        </el-form-item>
      </el-col>
      <el-col :xl="4" :lg="6" :md="8" :sm="12" :xs="24">
        <el-form-item label="类型" label-width="auto">
          <el-select v-model="form.type" placeholder="请选择类型" clearable @keyup.enter="handleSearch" style="width: 100%">
      ...
      <el-col :xl="4" :lg="6" :md="8" :sm="12" :xs="24">
        <el-form-item label="级别" label-width="auto">
          <el-select v-model="form.tier" placeholder="请选择级别" clearable @keyup.enter="handleSearch" style="width: 100%">
