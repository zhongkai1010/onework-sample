<template>
  <ele-page flex-table :multi-card="false" hide-footer style="min-height: 420px">
    <ele-card flex-table>
      ...
      >
        <template #toolbar>
          <el-button type="primary" class="ele-btn-icon" :icon="PlusOutlined" @click="openEdit()"> 新建展区 </el-button>
          ...
          <el-button type="danger" class="ele-btn-icon" :icon="DeleteOutlined" :disabled="!selections.length" @click="batchRemove"> 删除展区 </el-button>
        </template>
        <template #action="{ row }">
          <el-space :size="4">
