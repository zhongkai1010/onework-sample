        ...
        <el-row :gutter="16">
          ...
          <el-col :span="8">
            <el-form-item label="具体尺寸" prop="specificDimensions">
              <el-input
                v-model="form.specificDimensions"
                placeholder="请输入具体尺寸"
                clearable
              />
            </el-form-item>
    ...
    formRef.value?.validate?.((valid) => {
      ...
      if (isUpdate.value && props.data) {
        ...
        const updateData: Collection = {
          ...
          specificDimensions:
            form.specificDimensions ?? props.data.specificDimensions,
          ...
          collectionSource:
            form.collectionSource ?? props.data.collectionSource,
          condition: form.condition ?? props.data.condition,
          preservationStatus:
            form.preservationStatus ?? props.data.preservationStatus,
          collectionDate: form.collectionDate ?? props.data.collectionDate,
          collectionDateRange:
            form.collectionDateRange ?? props.data.collectionDateRange,
          ...
          collectionIntroduction:
            form.collectionIntroduction ?? props.data.collectionIntroduction,
          textType: form.textType ?? props.data.textType,
          audioVisualCarrierType:
            form.audioVisualCarrierType ?? props.data.audioVisualCarrierType,
          audioVisualStorageLocation:
            form.audioVisualStorageLocation ??
            props.data.audioVisualStorageLocation,
          diskPath: form.diskPath ?? props.data.diskPath,
          colorCategory: form.colorCategory ?? props.data.colorCategory,
          colorDescription:
            form.colorDescription ?? props.data.colorDescription,
