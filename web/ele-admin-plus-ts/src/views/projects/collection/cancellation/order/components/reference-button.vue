<template>
  ...
  <el-drawer v-model="open" title="页面内容" direction="rtl" size="50%" :destroy-on-close="true">
    <el-descriptions title="页面内容" :column="1" size="large" :border="true" :label-width="200">
      ...
      <el-descriptions-item label="搜索条件">展区位置</el-descriptions-item>
      <el-descriptions-item label="操作栏">展区变更</el-descriptions-item>
      <el-descriptions-item label="表格字段">编号 展区位置 藏品编号 藏品名称 藏品分类 年代类型 年代 数量 单位 具体尺寸 存放位置 备注 操作</el-descriptions-item>
