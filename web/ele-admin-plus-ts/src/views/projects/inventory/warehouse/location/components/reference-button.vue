<template>
  ...
  <el-drawer v-model="open" title="页面内容" direction="rtl" size="50%" :destroy-on-close="true">
    <el-descriptions title="页面内容" :column="1" size="large" :border="true" :label-width="200">
      ...
      <el-descriptions-item label="搜索条件"> 藏品编号 地址条码 绑定时间 </el-descriptions-item>
      <el-descriptions-item label="操作栏"> 绑定 </el-descriptions-item>
      <el-descriptions-item label="表格字段" :span="24"> 藏品编号 地址条码 绑定时间 </el-descriptions-item>
