  ...
  <ele-page plain :multi-card="false">
    ...
    <ele-page>
      <el-form ref="formRef" :model="form" :rules="rules" label-width="100px" @submit.prevent="">
        <ele-card header="仓库信息" :body-style="{ padding: '24px 20px 8px 2px' }">
          <el-row :gutter="12">
            <el-col :lg="8" :md="12" :sm="12" :xs="24">
              <el-form-item label="仓库名" prop="name">
                <el-input maxlength="40" clearable v-model="form.name" placeholder="请输入仓库名" />
              </el-form-item>
            </el-col>
            <el-col :lg="8" :md="12" :sm="12" :xs="24">
        ...
        <ele-card header="任务信息" :body-style="{ padding: '24px 20px 8px 2px' }">
          <el-row :gutter="12">
            <el-col :lg="8" :md="12" :sm="12" :xs="24">
              <el-form-item label="任务名" prop="task">
                <el-input clearable v-model="form.task" placeholder="请输入任务名" />
              </el-form-item>
            </el-col>
            <el-col :lg="8" :md="12" :sm="12" :xs="24">
              <el-form-item label="任务表述" prop="description">
                <el-input clearable v-model="form.description" placeholder="请输入任务表述" />
              </el-form-item>
            </el-col>
            <el-col :lg="8" :md="12" :sm="12" :xs="24">
        ...
        <ele-card header="选择成员">
          ...
          >
            <ele-table style="min-width: 580px; table-layout: fixed">
              ...
              <thead>
                <tr>
                  <th style="position: sticky; left: 0; z-index: 98" class="user-table-index"></th>
                  <th>用户名</th>
                  <th>工号</th>
                  <th>所属部门</th>
                  <th
              ...
              <tbody style="--ele-table-padding: 6px 8px">
                <tr v-for="(row, index) in form.users" :key="row.key">
                  ...
                  <td>
                    ...
                    >
                      <el-input clearable v-model="row.name" placeholder="请输入用户名" />
                    </el-form-item>
                  </td>
                  <td>
                    <el-form-item
                      ...
                      style="margin-bottom: 0"
                    >
                      <el-input clearable v-model="row.number" placeholder="请输入工号" />
                    </el-form-item>
                  </td>
                  <td>
                    <el-form-item
                ...
                <tr v-if="!form.users || !form.users.length">
                  <td colspan="5" style="text-align: center">
                    <ele-text style="padding: 4px 0" type="secondary"> 暂无数据 </ele-text>
                  </td>
                </tr>
              </tbody>
            </ele-table>
          </div>
          <el-button :icon="PlusOutlined" style="margin-top: 16px; width: 100%" @click="addUser">
